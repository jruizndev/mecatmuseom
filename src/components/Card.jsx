      ...
      <div className="absolute lg:w-[300px] lg:h-[350px] sm:w-[150px] sm:h-[0px] bg-white rounded-3xl p-2 z-10">
        <div className="relative w-full h-full">
          <img
            src={meme.image}
            alt={meme.description}
            className="absolute lg:max-h-[320px] lg:max-w-[290px] justify-center flex inset-0 object-cover rounded-3xl opacity-15"
          />
          <div className="relative lg:max-h-[270px] lg:max-w-[300px] sm:max-h-[170px] sm:max-w-[200px] p-4 z-10 bg-black/55 text-white top-2 rounded-3xl">
